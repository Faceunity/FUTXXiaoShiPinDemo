...
//    [Bugly startWithAppId:@"6efe67cbad" config:config];
    ...
    [TXUGCBase setLicenceURL:@"http://download-1252463788.cossh.myqcloud.com/xiaoshipin/licence_android/RDM_Enterprise.license" key:@"9bc74ac7bfd07ea392e8fdff2ba5678a"];
