...
///  视频预览回调
LITEAV_EXPORT @protocol TXVideoPreviewListener<NSObject>
...
/// 视频预览生成纹理回调
LITEAV_EXPORT @protocol TXVideoCustomProcessListener<NSObject>
@optional
...
/**
 ...
 该回调在SDK美颜之后. 纹理格式为GL_RGBA timestamp 为当前视频帧的 pts ，单位是ms
 ，客户可以根据自己的需求自定义滤镜特效
 */
...
/// 视频生成回调
LITEAV_EXPORT @protocol TXVideoGenerateListener<NSObject>
@optional
...
/// 视频合成回调
LITEAV_EXPORT @protocol TXVideoJoinerListener<NSObject>
@optional
